...
final class CutieHabExpenseDetailsViewModel: ObservableObject {
    private let expenseRepository: CutieHabExpenseRepository
    let expense: CutieHabExpense
    @Published var shouldPresentEditView = false
    
    init(expenseRepository: CutieHabExpenseRepository, expense: CutieHabExpense) {
