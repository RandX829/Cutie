...
final class Repositories: ObservableObject {
    // MARK: - HAB
    let habExpenseRepository = FirestoreCutieHabExpenseRepository()
    let habExpenseCategoryRepository = FirestoreCutieHabExpenseCategoryRepository()
    let habAccountRepository = FirestoreCutieHabAccountRepository()
}
